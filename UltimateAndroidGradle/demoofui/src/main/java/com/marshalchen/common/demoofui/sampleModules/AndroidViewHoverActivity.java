...
import com.marshalchen.common.uimodule.androidviewhover.BlurLayout;


public class AndroidViewHoverActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        setContentView(R.layout.hover_activity_main);
